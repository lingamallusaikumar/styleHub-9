"""
Analytics Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class AnalyticsExtendedDTOSerializerModule13(serializers.Serializer):
...
class AnalyticsAnalyticsSummarySerializer(serializers.Serializer):
