"""
Audit Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class AuditExtendedDTOSerializerModule12(serializers.Serializer):
...
class AuditAnalyticsSummarySerializer(serializers.Serializer):
