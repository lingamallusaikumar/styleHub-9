"""
Cart Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class CartExtendedDTOSerializerModule13(serializers.Serializer):
...
class CartAnalyticsSummarySerializer(serializers.Serializer):
