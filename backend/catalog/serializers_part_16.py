"""
Catalog Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class CatalogExtendedDTOSerializerModule16(serializers.Serializer):
...
class CatalogAnalyticsSummarySerializer(serializers.Serializer):
