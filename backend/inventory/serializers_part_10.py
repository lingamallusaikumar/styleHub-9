"""
Inventory Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class InventoryExtendedDTOSerializerModule10(serializers.Serializer):
...
class InventoryAnalyticsSummarySerializer(serializers.Serializer):
