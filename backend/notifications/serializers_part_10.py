"""
Notifications Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class NotificationsExtendedDTOSerializerModule10(serializers.Serializer):
...
class NotificationsAnalyticsSummarySerializer(serializers.Serializer):
