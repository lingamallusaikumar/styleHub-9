"""
Orders Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class OrdersExtendedDTOSerializerModule14(serializers.Serializer):
...
class OrdersAnalyticsSummarySerializer(serializers.Serializer):
