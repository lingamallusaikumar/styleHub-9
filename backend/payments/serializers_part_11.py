"""
Payments Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class PaymentsExtendedDTOSerializerModule11(serializers.Serializer):
...
class PaymentsAnalyticsSummarySerializer(serializers.Serializer):
