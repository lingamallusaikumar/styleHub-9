"""
Promotions Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class PromotionsExtendedDTOSerializerModule10(serializers.Serializer):
...
class PromotionsAnalyticsSummarySerializer(serializers.Serializer):
