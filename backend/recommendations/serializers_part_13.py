"""
Recommendations Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class RecommendationsExtendedDTOSerializerModule13(serializers.Serializer):
...
class RecommendationsAnalyticsSummarySerializer(serializers.Serializer):
