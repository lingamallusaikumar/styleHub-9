"""
Reviews Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class ReviewsExtendedDTOSerializerModule14(serializers.Serializer):
...
class ReviewsAnalyticsSummarySerializer(serializers.Serializer):
