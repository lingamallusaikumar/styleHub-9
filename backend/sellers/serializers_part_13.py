"""
Sellers Advanced REST Serializers & Data Transfer Objects (DTOs).
"""
from rest_framework import serializers

class SellersExtendedDTOSerializerModule13(serializers.Serializer):
...
class SellersAnalyticsSummarySerializer(serializers.Serializer):
